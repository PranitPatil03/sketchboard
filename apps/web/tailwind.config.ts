  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "collaby-textfield": "var(--SketchboardTextField--background)",
        "collaby-textfield-readonly":
          "var(--SketchboardTextField--readonly--background)",
      ...
      textColor: {
        "collaby-textfield": "var(--SketchboardTextField--color)",
        "collaby-textfield-label": "var(--SketchboardTextField--label-color)",
        "collaby-textfield-readonly":
          "var(--SketchboardTextField--readonly--color)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      borderColor: {
        "collaby-textfield": "var(--SketchboardTextField--border)",
        "collaby-textfield-readonly":
          "var(--SketchboardTextField--readonly--border)",
        "collaby-textfield-hover": "var(--SketchboardTextField--border-hover)",
        "collaby-textfield-active": "var(--SketchboardTextField--border-active)",
        "collaby-textfield-placeholder": "var(--SketchboardTextField--placeholder)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      fontFamily: {
        ...
        sketchboardfont: ["Sketchboardfont", "sans-serif"],
      },
      filter: {
