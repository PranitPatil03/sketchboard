        ...
        startTransition(async () => {
            try {
                ...
                if (response.success) {
                    ...
                    toast({ title: response.error || "Failed to fetch rooms.", variant: "destructive" });
                }
            } catch (error) {
                toast({ title: "Failed to fetch rooms", variant: "destructive" });
        ...
        startTransition(async () => {
            try {
                ...
                if (response && response.success) {
                    toast({ title: `Joining room: ${id}` });
                    onOpenChange(false);
                    router.push(`/room/${id}`);
                } else {
                    toast({ title: response?.error || "Failed to join room.", variant: "destructive" });
                }
            } catch (error) {
        ...
        startTransition(async () => {
            try {
                ...
                if (response.success) {
                    ...
                    toast({ title: response.error || "Failed to delete room.", variant: "destructive" });
                }
            } catch (error) {
