...
export function MainMenuWelcome() {
    return (
        <div className="sketchboardfont welcome-screen-decor welcome-screen-decor-hint welcome-screen-decor-hint--menu">
            ...
            <div className="welcome-screen-decor-hint__label font-sketchboardfont">Export, preferences, languages, ...</div>
        </div>
    )
}
...
export function ToolMenuWelcome() {
    return (
        <div className="sketchboardfont z-[4] welcome-screen-decor welcome-screen-decor-hint welcome-screen-decor-hint--toolbar">
    ...
    return (
        <>
            <div className="welcome-screen-center z-[3]">
                <div className="welcome-screen-center__logo sketchboardfont welcome-screen-decor">
                    <div className="SketchboardLogo is-small">
                        {/* <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="SketchboardLogo-icon">
                ...
                <div className="welcome-screen-center__heading welcome-screen-decor font-sketchboardfont">All your data is saved locally in your browser.</div>
