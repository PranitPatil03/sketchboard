...
export const metadata: Metadata = {
    ...baseMetadata,
    title: "About Sketchboard",
    description:
        "Learn about Sketchboard - a secure, end-to-end encrypted collaborative whiteboard tool. Discover features, privacy, encryption, and how it works.",
    openGraph: {
...
const aboutPageSchema = {
    ...
    "@type": "AboutPage",
    name: "About Sketchboard",
    description:
        "Sketchboard is a web-based collaborative whiteboard where multiple users can draw, edit, and brainstorm together in real time.",
    mainEntity: {
            ...
            <div className="space-y-xl bg-page-gradient-purple py-40">
                <section className="container max-w-screen-md space-y-sm text-color-primary-text">
                    ...
                    <div className="prose prose-invert prose-headings:text-white prose-a:text-blue-400 prose-strong:text-white prose-code:text-pink-400 max-w-none lg:text-xl">
                        <p>
                            <strong>Sketchboard</strong> is a web-based collaborative sketchboard
                        ...
                        <p>
                            Sketchboard is built with <strong>privacy by design</strong> to ensure
                        ...
                        <pre>
                            <code>https://your-domain.com/#room=abc123,xyz456</code>
                        </pre>
                        <ul className="flex flex-col gap-1">
                        ...
                        <ul className="flex flex-col gap-1">
                            ...
                            <li>
                                Works like <strong>Sketchboard&apos;s E2EE rooms</strong>, but tailored for your logic
                            </li>
                        </ul>
                        ...
                        <ul className="flex flex-col gap-1">
                            ...
                            <li><strong>Realtime:</strong> Native WebSocket</li>
